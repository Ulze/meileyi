...
<script>
	...
	/></noscript>
	<script src="//sellstuff.su/landings/module/feed.min.js" data-uid="ldqzNF0ahj4B9gW8"></script>
</head>
    ...
    <div class="landing">
      ...
      <div class="price1">
        <div class="price__old">
          Старая цена 
          <br>
          <span class="old_price_val"><span class="price_land_s2"><?=$oldprice?></span>999</span>
          <span class="old_price_cur"><span class="price_land_curr">грн.</span>999</span>
        </div>
        <div class="price__new">
          По акции 
          <br>
          <span class="new_price_val"><span class="price_land_s1"><?=$price?></span>399</span>
          <span class="new_price_cur"><span class="price_land_curr">грн.</span>399</span>
        </div>
      </div>
